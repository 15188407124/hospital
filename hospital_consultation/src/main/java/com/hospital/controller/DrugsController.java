...
public class DrugsController {
	...
	@ResponseBody
	public String DrugWithdrawal(@Param("patientId") String patientId, @Param("patientName") String patientName,
		...
		drugsService.stockUpdate(grant);
		drugsService.updateGrantDrugNum(withdrawalDrug);
		JSON json = JSONSerializer.toJSON(new JsonResult<List<GrantDrugs>>());
		return json.toString();
	}
