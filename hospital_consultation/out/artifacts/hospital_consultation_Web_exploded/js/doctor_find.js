    ...
    if (list.length > 0) {
        for (var i = start; i < end; i++) {
            ...
            var $tr = $(trStyle
                ...
                + state
                + "</td>"
                + "<td class='name'><a href='doctor_edit.html?id="+doctor.id+"' title='编辑'><i class=\"layui-icon\">&#xe642;</i></a>&nbsp;&nbsp;&nbsp;&nbsp;"
                + "	<a title=\"离职\" onclick=\"doctor_del('"+doctor.id+"');\" href=\"javascript:;\"><i class=\"layui-icon\">&#xe640;</i></a></td>"
                + "</tr>");
            $tbody.append($tr);
            location.reload();
        }
            ...
            if (result.state == 0) {
                layer.alert("增加成功", {
                    ...
                    shade:0.3,
                        ...
                        window.location.href="doctor_find.html";
                    }
                })
            }
            if (result.state == 1) {
